...
The result should look like a critique of low-quality promotional AI imagery: slick, hollow, overproduced, and faintly wrong, while still preserving the source image.
Avoid changing faces beyond recognition, adding fake text, adding logos, inventing extra objects, creating body errors, or making the image chaotic. The satire should come from over-polish and bland uncanniness.
