...
The result should feel stylish, current, and visually charged, with spirals used as a design language rather than a random overlay.
Avoid turning the whole image into abstraction, adding fake text, changing faces, inventing objects, or overwhelming the main subject with excessive pattern.
