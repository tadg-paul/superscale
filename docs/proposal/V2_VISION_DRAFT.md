...
# Superscale UX v2 Vision Draft

> **Historical draft.** The canonical v2 vision now lives in
> [`docs/VISION.md`](../VISION.md). This draft is retained as design provenance.
...
## Planning Docs At Time Of Draft
